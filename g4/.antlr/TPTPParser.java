...
public class TPTPParser extends Parser {
	...
	public static final int
		...
		WS=60, Comment_line=61, Comment_block=62, Single_quoted=63, Back_quoted=64, 
		Distinct_object=65, Dollar_word=66, Dollar_dollar_word=67, Upper_word=68, 
		Lower_word=69, Real=70, Signed_real=71, Unsigned_real=72, Decimal_exponent=73, 
		Decimal_fraction=74, Exp_integer=75, Signed_exp_integer=76, Rational=77, 
		Signed_rational=78, Unsigned_rational=79, Integer=80, Signed_integer=81, 
		Unsigned_integer=82, Positive_integer=83, Integer_digits=84, Slash=85, 
		Slosh=86, Vline=87, Star=88, Plus=89, Arrow=90, Less_sign=91, Hash=92, 
		Not_star_slash=93, Percentage_sign=94, Double_quote=95, Single_quote=96, 
		Back_quote=97, Dot=98, Slash_char=99, Slosh_char=100, Zero_numeric=101, 
		Underscore=102, Alpha=103, Dollar=104, Printable_char=105, Viewable_char=106;
	public static final int
	...
	public final Atomic_wordContext atomic_word() throws RecognitionException {
		...
		try {
			...
			setState(1737);
			_la = _input.LA(1);
			if ( !(((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & 67L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final NumberContext number() throws RecognitionException {
		...
		try {
			...
			setState(1743);
			_la = _input.LA(1);
			if ( !(((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 1153L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
