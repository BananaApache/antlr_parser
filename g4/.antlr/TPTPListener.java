...
public interface TPTPListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TPTPParser#ntf_defined_connective}.
	 * @param ctx the parse tree
	 */
	void enterNtf_defined_connective(TPTPParser.Ntf_defined_connectiveContext ctx);
	/**
	 * Exit a parse tree produced by {@link TPTPParser#ntf_defined_connective}.
	 * @param ctx the parse tree
	 */
	void exitNtf_defined_connective(TPTPParser.Ntf_defined_connectiveContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterType_quantifier(TPTPParser.Type_quantifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link TPTPParser#type_quantifier}.
	 * @param ctx the parse tree
	 */
	void exitType_quantifier(TPTPParser.Type_quantifierContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TPTPParser#typeable_atom}.
	 * @param ctx the parse tree
	 */
	void enterTypeable_atom(TPTPParser.Typeable_atomContext ctx);
	/**
	 * Exit a parse tree produced by {@link TPTPParser#typeable_atom}.
	 * @param ctx the parse tree
	 */
	void exitTypeable_atom(TPTPParser.Typeable_atomContext ctx);
	/**
	 * Enter a parse tree produced by {@link TPTPParser#atomic_type}.
	 * @param ctx the parse tree
	 */
	void enterAtomic_type(TPTPParser.Atomic_typeContext ctx);
	/**
	 * Exit a parse tree produced by {@link TPTPParser#atomic_type}.
	 * @param ctx the parse tree
	 */
	void exitAtomic_type(TPTPParser.Atomic_typeContext ctx);
	/**
